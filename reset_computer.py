...
def reset(JPS_URL, JPS_USERNAME,JPS_PASSWORD):
    ...
    # x = classic.get_policy(name="001_rosetta_creation_trial",data_type="xml")
    # print(x)
    # with open("output.txt", "w") as f:
    #     f.write(str(x))
    # exit() 
    ...
    try:
        classic.delete_policy(name="001_rosetta_creation_trial")
    ...
    try:
        classic.delete_policy(name="003_enable_location_services")
    except Exception as e:
        print(f"Failed to delete policy: {e}")
        print("Ignore")
    ...
    try:
        classic.delete_script(name="rosetta_creation")
    except Exception as e:
    ...
    try:
        classic.delete_script(name="enable_location_services")
    except Exception as e:
        print(f"Failed to delete script: {e}")
        print("Creating a NEW one...")
    ...
    with Pro(JPS_URL, JPS_USERNAME,JPS_PASSWORD) as pro:
        ...
        pro.create_script(
            {
                "name": "enable_location_services",
                "info": "Enable location services.",
                "notes": "",
                "priority": "AFTER",
                "categoryId": "1",
                "categoryName": "Developer Tools",
    ...
    #create a policy for rosetta creation
    script_id = classic.get_script(name="rosetta_creation")['script']['id']
    script_name = classic.get_script(name="rosetta_creation")['script']['name']
    ...
    classic.create_policy(
        ...
        <policy>
            <general>
                <name>001_rosetta_creation_trial</name>
            ...
            <self_service>
                ...
                <notification_subject>001_</notification_subject>
    ...
    # create a policy for enabling location services
    script_id = classic.get_script(name="enable_location_services")['script']['id']
    script_name = classic.get_script(name="enable_location_services")['script']['name']
    # computer_group_id = classic.get_computer_group(name="intended_for_local_user_account_creation_and_printer_driver_creation_trial")['computer_group']['id']
    # computer_group_name = classic.get_computer_group(name="intended_for_local_user_account_creation_and_printer_driver_creation_trial")['computer_group']['name']
    ...
    classic.create_policy(
        ...
        <policy>
            <general>
                <id/>
                <name>003_enable_location_services</name>
                <enabled>true</enabled>
                <trigger>EVENT</trigger>
                <trigger_checkin>false</trigger_checkin>
                <trigger_enrollment_complete>true</trigger_enrollment_complete>
    ...
    with Classic(JPS_URL, JPS_USERNAME,JPS_PASSWORD) as classic:
        ...
        for i_index, i_value in enumerate(shared.excel_data):
            ...
            try:
                ...
                for_the_managemenent_id_list.append(for_the_managemenent_id)
            except Exception as e:
            ...
            with Pro(JPS_URL, JPS_USERNAME,JPS_PASSWORD) as pro:
                try:
                    ...
                    management_id_list.append(management_id)
                    print(management_id)
                except Exception as e:
                    print(f"Error retrieving device {SerialNumber}: {e}")
                    shared.missing_computers.append(SerialNumber)
    ...
    # exit()
        ...
        for i_index, i_value in enumerate(shared.excel_data):
                pro.create_mdm_command(
                    ...
                    "clientData": [
                        {
                        "managementId": management_id_list[i_index]
                        }
                    ]
                    }
                )
